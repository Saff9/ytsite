  ...
  return (
    <html lang="en" data-theme="dark" suppressHydrationWarning>
      <head>
        ...
        {/* Banner Ad Script */}
        <script async data-cfasync="false" src="https://pl28791059.effectivegatecpm.com/0468e4bd50315776ced555d5c77276f3/invoke.js" />
      </head>
      <body className="flex flex-col min-h-screen bg-black text-white antialiased">
        ...
        <main className="flex-grow">
          {/* Banner Ad Container */}
          <div id="container-0468e4bd50315776ced555d5c77276f3" className="w-full flex justify-center my-4"></div>
          {children}
        </main>
        <Footer />
